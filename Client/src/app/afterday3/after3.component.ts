...
@Component({
  selector: 'app-today',
  templateUrl: './after3.component.html',
  styleUrls: ['./after3.component.css']
})
export class After3 implements OnInit {
  info: any;
  List: Object;
  ...
  //this.service.getAfter3.then(result => this.data = result);
  this.service.getAfter3().subscribe(data => this.List = data);
