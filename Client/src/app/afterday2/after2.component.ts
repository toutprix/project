...
@Component({
  selector: 'app-today',
  templateUrl: './after2.component.html',
  styleUrls: ['./after2.component.css']
})
export class After2 implements OnInit {
  info: any;
  List: Object;
  ...
  //this.service.getAfter2().then(result => this.data = result);
  this.service.getAfter2().subscribe(data => this.List = data);
